...
namespace DatagridProducts
{
    public partial class Form1 : Form
    {
        ...
        // Initialize data grid view on form load
        private void Form1_Load(object sender, EventArgs e)
        {
            dgvProducts.DataSource = productlist.ToList();
        }

        // Products out of stock
        private void btnOutOfStock_Click(object sender, EventArgs e)
        {
            dgvProducts.DataSource = productlist.Where(p => p.UnitsInStock == 0).ToList();
        }
        ...
        // Stock with unit cost > 3M
        private void btnStockWithCostMoreThan3_Click(object sender, EventArgs e)
        {
            dgvProducts.DataSource = productlist.Where(s => s.UnitsInStock > 0 && s.UnitPrice > 3M).ToList();
        }

        // Product names only
        private void btnProductNamesOnly_Click(object sender, EventArgs e)
        {
            dgvProducts.DataSource = (from p in productlist
        ...
        private void btnCapitalizeProductName_Click(object sender, EventArgs e)
        {
            dgvProducts.DataSource = (
                ...
                select new
                {
                    ...
                    Category = p.Category,
                    Price = Math.Round(p.UnitPrice, 2),
                    UnitsInStock = p.UnitsInStock
                }
                ).ToList();
        }

        private void btnOrderByProductNameLength_Click(object sender, EventArgs e)
        {
            dgvProducts.DataSource = productlist.OrderBy(p => p.ProductName.Length).ToList();
        }

        private void btnOrderByDescendingUnitsInStock_Click(object sender, EventArgs e)
        {
            dgvProducts.DataSource = productlist.OrderByDescending(u => u.UnitsInStock).ToList();
        }

        private void btnOrderByProductNameLengthThenAlphabetically_Click(object sender, EventArgs e)
        {
            dgvProducts.DataSource = productlist.OrderBy(p => p.ProductName.Length).
                ThenBy(p => p.ProductName).
                ToList();
        }

        private void btnProductWhereSecondLetterIsH_Click(object sender, EventArgs e)
        {
            dgvProducts.DataSource = productlist.Where(p => p.ProductName[1] == 'h').ToList();
        }
        ...
        private void btnGroupByCategoryAndCountProducts_Click(object sender, EventArgs e)
        {
            dgvProducts.DataSource = (from p in productlist
        ...
        private void btnTotalUnitsOfStockForEachCategory_Click(object sender, EventArgs e)
        {
            dgvProducts.DataSource = (from p in productlist
                                      group p by p.Category
                                      into g
                                      ...
                                      {
                                          Category = g.Key,
                                          UnitsInStock = g.Sum(u => u.UnitsInStock)
                                      }
                                      ).ToList();
        }

        private void btnCheapestInCategory_Click(object sender, EventArgs e)
        {
            dgvProducts.DataSource = (from p in productlist
                                      group p by p.Category
                                      into g
                                      ...
                                      {
                                          Category = g.Key,
                                          CheapestPrice = Math.Round(g.Min(o => o.UnitPrice), 2),
                                          AveragePrice = Math.Round(g.Average(o => o.UnitPrice), 2),
                                          HighestPrice = Math.Round(g.Max(o => o.UnitPrice), 2)
                                      }
                                      ).ToList();
        }
    }
